					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragments Example",
									"targetURL": "#pfragmets-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pfragmets-display": {
								"semanticObject": "pfragmets",
								"action": "display",
								"description": "Fragment Example with XML view and controller",
								"title": "Fragments Example",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pfragmets",
									"url": sap.ui.require.toUrl("pfragmets")
								}
							}
						}
					}
