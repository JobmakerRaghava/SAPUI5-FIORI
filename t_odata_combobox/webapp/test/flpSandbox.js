		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ComboBox",
									"targetURL": "#todatacombobox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"todatacombobox-display": {
								"semanticObject": "todatacombobox",
								"action": "display",
								"description": "Combobox with Odata service",
								"title": "ComboBox",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=todatacombobox",
									"url": sap.ui.require.toUrl("todatacombobox")
								}
							}
						}
					}
