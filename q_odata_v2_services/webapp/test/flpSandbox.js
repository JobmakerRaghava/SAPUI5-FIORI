		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#qodatav2services-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"qodatav2services-display": {
								"semanticObject": "qodatav2services",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=qodatav2services",
									"url": sap.ui.require.toUrl("qodatav2services")
								}
							}
						}
					}
