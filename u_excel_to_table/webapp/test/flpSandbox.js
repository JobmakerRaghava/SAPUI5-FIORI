		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Excel upload ",
									"targetURL": "#uexceltotable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uexceltotable-display": {
								"semanticObject": "uexceltotable",
								"action": "display",
								"description": "Read Data From Excel File (.XLSX) In SAP UI5 App And Display Contents In Table",
								"title": "Excel upload ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uexceltotable",
									"url": sap.ui.require.toUrl("uexceltotable")
								}
							}
						}
					}
