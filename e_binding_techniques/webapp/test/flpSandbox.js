		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bindingtechniques-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bindingtechniques-display": {
								"semanticObject": "bindingtechniques",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bindingtechniques",
									"url": sap.ui.require.toUrl("bindingtechniques")
								}
							}
						}
					}
