		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table Control",
									"targetURL": "#itablecontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itablecontrol-display": {
								"semanticObject": "itablecontrol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=itablecontrol",
									"url": sap.ui.require.toUrl("itablecontrol")
								}
							}
						}
					}
