		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#resoucemodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"resoucemodel-display": {
								"semanticObject": "resoucemodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=resoucemodel",
									"url": sap.ui.require.toUrl("resoucemodel")
								}
							}
						}
					}
