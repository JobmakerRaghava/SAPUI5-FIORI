		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Split app with odata V2",
									"targetURL": "#rodatav2services-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rodatav2services-display": {
								"semanticObject": "rodatav2services",
								"action": "display",
								"description": "Split app with odata V2",
								"title": "Split app with odata V2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rodatav2services",
									"url": sap.ui.require.toUrl("rodatav2services")
								}
							}
						}
					}
