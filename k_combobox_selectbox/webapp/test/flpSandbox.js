		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ComboBox and SelectBox",
									"targetURL": "#comboboxselectbox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comboboxselectbox-display": {
								"semanticObject": "comboboxselectbox",
								"action": "display",
								"description": "ComboBox and SelectBox",
								"title": "ComboBox and SelectBox",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=comboboxselectbox",
									"url": sap.ui.require.toUrl("comboboxselectbox")
								}
							}
						}
					}
