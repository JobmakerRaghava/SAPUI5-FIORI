		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Named Models",
									"targetURL": "#z08namedmodels-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z08namedmodels-display": {
								"semanticObject": "z08namedmodels",
								"action": "display",
								"description": "Named models",
								"title": "Named Models",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z08namedmodels",
									"url": sap.ui.require.toUrl("z08namedmodels")
								}
							}
						}
					}
