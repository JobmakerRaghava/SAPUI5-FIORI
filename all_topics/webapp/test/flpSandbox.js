					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 with OData",
									"targetURL": "#alltopics-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"alltopics-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=alltopics",
									"url": sap.ui.require.toUrl("alltopics")
								}
							}
						}
					}
