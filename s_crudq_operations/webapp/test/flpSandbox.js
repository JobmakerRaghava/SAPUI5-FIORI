		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sandeep Gunisetti Fans",
									"targetURL": "#crudqoperations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"crudqoperations-display": {
								"semanticObject": "crudqoperations",
								"action": "display",
								"description": "Crudq operations using Odata",
								"title": "Sandeep Gunisetti Fans",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=crudqoperations",
									"url": sap.ui.require.toUrl("crudqoperations")
								}
							}
						}
					}
